...
mod tests {
    ...
    // Source: vol-arb/scripts/essvi_fixtures/fail_00.json (3 tenors, all with vol cliffs).

    #[test]
    fn calibrate_real_data_fail_00() {
        let tenors = vec![
            0.13523651988744392,
            0.21189634192714274,
            0.28581831317970946,
        ];
        let forwards = vec![6079.713483566315, 6099.694029589387, 6119.023171024892];

        #[rustfmt::skip]
        let tenor_0: Vec<(f64, f64)> = vec![
            (6100.0, 0.0625982147), (6190.0, 0.0696515411), (6225.0, 0.0714072411),
            (6290.0, 0.0741890122), (6375.0, 0.0776351200), (6390.0, 0.0784630171),
            (6410.0, 0.0794775855), (6475.0, 0.0835843816),
            (4920.0, 0.3110087439), (4940.0, 0.3073343432), (4975.0, 0.3011240882),
            (4980.0, 0.3004974430), (4990.0, 0.2985944628), (5010.0, 0.2953695994),
            (5120.0, 0.2774264040), (5125.0, 0.2766377347), (5170.0, 0.2697630615),
            (5210.0, 0.2639499306), (5280.0, 0.2537524917), (5325.0, 0.2476851188),
            (5350.0, 0.2443583765), (5380.0, 0.2404972645), (5410.0, 0.2368659288),
            (5425.0, 0.2348995580), (5440.0, 0.2332533279), (5475.0, 0.2295732164),
            (5490.0, 0.2279191240), (5500.0, 0.2267898169), (5515.0, 0.2252920491),
            (5535.0, 0.2231654284), (5555.0, 0.2211387287), (5590.0, 0.2177619895),
            (5625.0, 0.2145773033), (5650.0, 0.2123859532), (5655.0, 0.2119841767),
            (5660.0, 0.2115634725), (5720.0, 0.2068946031), (5795.0, 0.2021010369),
            (5805.0, 0.2014866825), (5815.0, 0.2009211930), (5870.0, 0.1986755177),
            (5875.0, 0.1984272409), (5990.0, 0.1977418265), (6025.0, 0.1995377662),
            (6055.0, 0.2015902963),
        ];

        #[rustfmt::skip]
        let tenor_1: Vec<(f64, f64)> = vec![
        ...
        #[rustfmt::skip]
        let tenor_2: Vec<(f64, f64)> = vec![
            (6190.0, 0.0814246469), (6225.0, 0.0819148928), (6240.0, 0.0820691536),
            (6280.0, 0.0825094554), (6300.0, 0.0827143828), (6350.0, 0.0831490853),
            (6370.0, 0.0833597327), (6475.0, 0.0843232803), (6480.0, 0.0843073431),
            (6600.0, 0.0860975254), (6650.0, 0.0871861196), (6800.0, 0.0926400581),
            (5000.0, 0.2657648657), (5050.0, 0.2604295763), (5160.0, 0.2489918077),
            (5170.0, 0.2480012836), (5210.0, 0.2440206592), (5260.0, 0.2389792425),
            (5290.0, 0.2361005452), (5325.0, 0.2326834608), (5370.0, 0.2284986192),
            (5450.0, 0.2211815222), (5480.0, 0.2185285630), (5570.0, 0.2107268980),
            (5575.0, 0.2103443738), (5590.0, 0.2091466059), (5600.0, 0.2081954161),
            (5640.0, 0.2048951150), (5650.0, 0.2041058793), (5670.0, 0.2025267252),
            (5675.0, 0.2021356195), (5710.0, 0.1993980377), (5835.0, 0.1906101322),
            (5860.0, 0.1890801527), (5885.0, 0.1876195581), (5915.0, 0.1859675502),
            (5990.0, 0.1828973609), (6055.0, 0.1814067206), (6060.0, 0.1813205322),
        ];
